...
Celebrity:
	faceplayer
	opentext
	checkevent EVENT_GOT_PP_UP_CELEB
	iftrue .AlreadyGotItem
	writetext CelebrityText1
	promptbutton
	verbosegiveitem PP_UP
	iffalse .Done
	setevent EVENT_GOT_PP_UP_CELEB
.Done:
	closetext
	end
.AlreadyGotItem:
...
Route28SteelWingHouse_MapEvents:
	...
	object_event  6,  5, SPRITE_PIDGEY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CelebritysFearow, -1
