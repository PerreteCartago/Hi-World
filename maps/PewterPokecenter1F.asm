	...
	const PEWTERPOKECENTER1F_MYSTIA
...
PewterPokecenter1F_MapEvents:
	...
	object_event  1,  3, SPRITE_GENGAR, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PewterMystia, -1
