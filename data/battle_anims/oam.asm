...
; entries correspond to BATTLE_ANIM_OAMSET_* constants
	...
	battleanimoam $09,  4, .OAMData_02  ; BATTLEANIMOAMSET_GUNK_SHOT_1
	battleanimoam $0a,  9, .OAMData_GunkShot  ; BATTLEANIMOAMSET_GUNK_SHOT_2
	battleanimoam $00, 18, .OAMData_Hurricane  ; BATTLEANIMOAMSET_HURRICANE
	battleanimoam $0e,  4, .OAMData_03  ; BATTLEANIMOAMSET_PHANTOM_DAZE_VERTICAL
	battleanimoam $12,  4, .OAMData_03  ; BATTLEANIMOAMSET_PHANTOM_DAZE_DIAGONAL
	battleanimoam $0a,  4, .OAMData_03  ; BATTLEANIMOAMSET_PHANTOM_DAZE_HORIZONTAL
	battleanimoam $00, 36, .OAMData_BigGlow1  ; BATTLEANIMOAMSET_BIG_GLOW_1
	battleanimoam $00, 29, .OAMData_BigGlow2 ; BATTLEANIMOAMSET_BIG_GLOW_2
	battleanimoam $09, 16, .OAMData_00  ; BATTLEANIMOAMSET_BIG_GLOW_3
	battleanimoam $00,  9, .OAMData_c3  ; BATTLEANIMOAMSET_LAVA_PLUME_SMOKE
	battleanimoam $09,  4, .OAMData_02  ; BATTLEANIMOAMSET_MUDSHOT
