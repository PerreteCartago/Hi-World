...
; ANIM_OBJ_LEAF_STORM_BIG_LEAF
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $94, BATTLEANIMFRAMESET_LEAF_STORM_BIG_LEAF, BATTLEANIMFUNC_LEAF_STORM, PAL_BATTLE_OB_GREEN, ANIM_GFX_LEAF_STORM
; ANIM_OBJ_LEAF_STORM_SMALL_LEAF
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $94, BATTLEANIMFRAMESET_LEAF_STORM_SMALL_LEAF, BATTLEANIMFUNC_LEAF_STORM, PAL_BATTLE_OB_GREEN, ANIM_GFX_LEAF_STORM
; ANIM_OBJ_BIG_GLOW
...
; ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X, $9a, BATTLEANIMFRAMESET_1B, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS 
; ANIM_OBJ_HURRICANE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_HURRICANE, BATTLEANIMFUNC_HIDDEN_POWER_FAST, PAL_BATTLE_OB_GRAY, ANIM_GFX_HURRICANE
; ANIM_OBJ_GUNK_SHOT
...
; ANIM_OBJ_GUNK_SHOT_BUBBLES
	battleanimobj RELATIVE_X, $8c, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_BUBBLE_SPLASH, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON
; ANIM_OBJ_PHANTOM_DAZE_N
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $86, BATTLEANIMFRAMESET_PHANTOM_DAZE_N, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_NE
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLEANIMFRAMESET_PHANTOM_DAZE_NE, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_E
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_PHANTOM_DAZE_E, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_SE
	battleanimobj RELATIVE_X | X_FLIP, $95, BATTLEANIMFRAMESET_PHANTOM_DAZE_SE, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_S
	battleanimobj RELATIVE_X | X_FLIP, $98, BATTLEANIMFRAMESET_PHANTOM_DAZE_S, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_SW
	battleanimobj RELATIVE_X | X_FLIP, $95, BATTLEANIMFRAMESET_PHANTOM_DAZE_SW, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_W
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_PHANTOM_DAZE_W, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_PHANTOM_DAZE_NW
	battleanimobj RELATIVE_X | X_FLIP, $88, BATTLEANIMFRAMESET_PHANTOM_DAZE_NW, BATTLEANIMFUNC_PHANTOM_DAZE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS_4
; ANIM_OBJ_INK_SPLASH
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_INK_SPLASH, BATTLEANIMFUNC_BUBBLE_SPLASH, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON
