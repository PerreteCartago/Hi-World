...
TreeMonMaps:
	...
	treemon_map ROUTE_29,                  TREEMON_SET_FOREST
	treemon_map ROUTE_30,                  TREEMON_SET_FOREST
	treemon_map ROUTE_31,                  TREEMON_SET_FOREST
	treemon_map ROUTE_32,                  TREEMON_SET_FOREST
	treemon_map ROUTE_33,                  TREEMON_SET_TOWN
	treemon_map ROUTE_34,                  TREEMON_SET_TOWN
	...
	treemon_map OLIVINE_CITY,              TREEMON_SET_ROUTE
	treemon_map ECRUTEAK_CITY,             TREEMON_SET_TOWN
	treemon_map MAHOGANY_TOWN,             TREEMON_SET_LAKE
