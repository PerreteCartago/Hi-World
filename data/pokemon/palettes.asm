...
INCBIN "gfx/pokemon/cyuuto/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/cyuuto/shiny.pal"
INCBIN "gfx/pokemon/yuuto/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/yuuto/shiny.pal"
