...
MapGroup_Olivine:
	...
	map OlivinePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map OlivineMart, TILESET_MART, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route38EcruteakGate, TILESET_GATE, GATE, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route39Barn, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route39Farmhouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map MahoganyPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_MAHOGANY_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map SilverCaveRoom1, TILESET_CAVE, CAVE, LANDMARK_SILVER_CAVE, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	...
	map RockTunnel1F, TILESET_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map EcruteakMart, TILESET_MART, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map BlackthornMart, TILESET_MART, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BlackthornPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map CinnabarPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanGym, TILESET_PORT, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route10Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route10Pokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_25, MUSIC_NUGGET_BRIDGE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map AzaleaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CharcoalKiln, TILESET_HOUSE, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AzaleaMart, TILESET_MART, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletMart, TILESET_MART, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VioletPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route32Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_32, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreRoof, TILESET_MART, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokecomCenterAdminOfficeMobile, TILESET_POKECOM_CENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VermilionMart, TILESET_MART, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderMart, TILESET_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Silver:
	...
	map SilverCavePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SILVER_CAVE, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_CableClub:
	...
	map Pokecenter2F, TILESET_POKECENTER, INDOOR, LANDMARK_SPECIAL, MUSIC_EIRIN_CENTER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonDeptStore1F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_MART, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map CianwoodPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianMart, TILESET_MART, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SaffronMart, TILESET_MART, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map CherrygroveMart, TILESET_MART, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CherrygrovePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_EIRIN_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
