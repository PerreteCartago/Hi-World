...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_PHANTOM_DAZE_N
	const ANIM_OBJ_PHANTOM_DAZE_NE
	const ANIM_OBJ_PHANTOM_DAZE_E
	const ANIM_OBJ_PHANTOM_DAZE_SE
	const ANIM_OBJ_PHANTOM_DAZE_S
	const ANIM_OBJ_PHANTOM_DAZE_SW
	const ANIM_OBJ_PHANTOM_DAZE_W
	const ANIM_OBJ_PHANTOM_DAZE_NW
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLEANIMFUNC_PHANTOM_DAZE
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_N
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_NE
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_E
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_SE
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_S
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_SW
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_W
	const BATTLEANIMFRAMESET_PHANTOM_DAZE_NW
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLEANIMOAMSET_GUNK_SHOT_1
	const BATTLEANIMOAMSET_GUNK_SHOT_2
	const BATTLEANIMOAMSET_HURRICANE
	const BATTLEANIMOAMSET_PHANTOM_DAZE_VERTICAL
	const BATTLEANIMOAMSET_PHANTOM_DAZE_DIAGONAL
	const BATTLEANIMOAMSET_PHANTOM_DAZE_HORIZONTAL
	const BATTLEANIMOAMSET_BIG_GLOW_1
	const BATTLEANIMOAMSET_BIG_GLOW_2
	const BATTLEANIMOAMSET_BIG_GLOW_3
	const BATTLEANIMOAMSET_LAVA_PLUME_SMOKE
	const BATTLEANIMOAMSET_MUDSHOT
